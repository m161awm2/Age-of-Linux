...
def draw(stdscr, width, height, ground_y, p_units, e_units, gold, p_hp, e_hp, 
    ...
    # 궁수(Archer) 이름 매핑
    arc_names = {"&": "Archer", "M": "Musketeer", "J": "Javelin"}
    # 기병(Cavalry) 이름 매핑
    cav_names = {"@": "Knight", "C": "Chariot", "W": "W.Hussar"}
    ...
    if show_promo_mode > 0:
        ...
        if show_promo_mode == 1:
            ...
            stdscr.addstr(start_y + 3, start_x + 3, "[6] Spearman: ANTI KNIGHT, Range 2 (4G)", curses.color_pair(1))
