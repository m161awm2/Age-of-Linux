...
WINGED_HUSSAR_MAX_DAMAGE_BONUS = 0.3
...
class Unit:
    def __init__(self, kind, team, x):
        ...
        if kind == "#": # 기본 보병
            ...
            base_hp, base_dmg = 27, 13 # 돌격 가속을 고려해 단발 데미지 조정
